 ...
 */
final class Version20250623083423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE nft (id SERIAL NOT NULL, name VARCHAR(255) NOT NULL, pattern VARCHAR(255) NOT NULL, collection VARCHAR(255) NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE "user" (id SERIAL NOT NULL, name VARCHAR(30) NOT NULL, password_hash VARCHAR(255) NOT NULL, auth_token VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
